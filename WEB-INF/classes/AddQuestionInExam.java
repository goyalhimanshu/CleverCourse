...
public class AddQuestionInExam extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		out.println("<table>");
		out.println("<form id=\"form1\" name=\"form1\"  action=AddQuestionInExam method=\"post\">");
	    out.println("<tr>");
		out.println("<td width=\"169\">Exam:</td>");
		out.println("<td width=\"214\">");
	    out.println("<input type=text name=\"exam\" readonly=true value="+exam+">");
		out.println(" </td>");
		out.println("</tr>");
		out.println("<tr>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(i==1)
		{
			...
			out.println("<a href=\"ChooseExam\" ><input type=submit value=\"Add More Question\"></a>");
