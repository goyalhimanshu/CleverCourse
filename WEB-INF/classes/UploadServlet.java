...
public class UploadServlet extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, 
      ...
      if( !isMultipart )
	  {
		...
		out.println("<a href=\"#\"><img src=\"images/yourlogo.png\"></a>");
		out.println("</div>");
		out.println("<p>Other content for your header</p>");
		out.println("</div>");
		out.println("</div>");
	    out.println("<p>No file uploaded</p><br/>"); 
...
pw.println("</div>");
     ...
     out.println("<html>");
		out.println("<head>");
		out.println("<link href=\"../css/styles.css\" type=\"text/css\" rel=\"stylesheet\" />");
		out.println("<title align=center>Servlet upload</title>");  
		out.println("</head>");
      out.println("<body>");
	  out.println("<div id=\"header\">");
		out.println("<div class=\"wrap\">");
	  ...
	  out.println("<form action=\"AddQuestion?exam="+exam+"\" >");
