...
public class ChooseExam extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		out.println("<table>");
		out.println("<form id=\"form1\" name=\"form1\"  action=AddQuestionInExam method=\"get\">");
		out.println("<tr>");
		out.println("<td width=\"169\">Select Exam::</td>");
		out.println("<td width=\"214\">");
	    out.println("<select name=exam>");
		...
		try
		{
			...
			while(rs.next())
			{
				pw.println("<option value=\""+(rs.getString("name")).toUpperCase()+"\">"+(rs.getString("name")).toUpperCase()+"</option>");
			}
		}
		catch(Exception e)
		{
		...
		out.println("<input type=\"submit\" name=\"chooseexam\" value=\"Add Question\" />");
		out.println("</div>");
		out.println("</form>");
		out.println("</div></td>");
		out.println("</tr>");
